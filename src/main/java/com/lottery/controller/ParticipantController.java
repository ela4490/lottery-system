...
public class ParticipantController {
    ...
    public RegisterParticipantResponseDto register(@Valid @RequestBody RegisterParticipantRequestDto registerParticipantRequestDto) {
        ...
        final var registerParticipantRequest = beanMapper.map(registerParticipantRequestDto, RegisterParticipantRequest.class);
        final var participantId = participantService.register(registerParticipantRequest);
    ...
    public ParticipantBallotsResponseDto submit(@Valid @RequestBody SubmissionRequestDto requestDto, @PathVariable String ssn) {
        ...
        final var submissionRequest = beanMapper.map(requestDto, SubmissionRequest.class);

...
import com.lottery.controller.dto.ApiResponseDto;
import com.lottery.controller.dto.CreateLotteryRequestDto;
import com.lottery.controller.dto.CreateLotteryResponseDto;
import com.lottery.controller.dto.LotteryResponseDto;
...
public class LotteryController {
    ...
    public CreateLotteryResponseDto create(@Valid @RequestBody CreateLotteryRequestDto createLotteryRequestDto) {
        LOG.info("Creating lottery with request: {}", createLotteryRequestDto);
        final var createLotteryRequest = beanMapper.map(createLotteryRequestDto, CreateLotteryRequest.class);
        ...
        LOG.debug("Created lottery with response: {}", createLotteryResponseDto);
